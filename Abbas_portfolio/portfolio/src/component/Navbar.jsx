...
export default function Navbar(){
    return (
        <>
    <nav className="bg-purple-800 text-white p3  flex justify-between items-center h-16 fixed w-full">
        <div className="relative left-7 font-bold px-2 text-xl">
          <p>PORTFOLIO</p>
        </div>
        <div>
            <ul className='relative right-4 flex justify-around items-center gap-2 md:gap-5'>
